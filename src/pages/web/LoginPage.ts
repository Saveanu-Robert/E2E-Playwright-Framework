...
import { UserCredentials } from '@data/testdata/saucedemo.users';
...
export class LoginPage {
  ...
  async login(credentials: UserCredentials): Promise<void> {
    console.log(`🔐 Attempting login with user: ${credentials.username} (${credentials.description})`);
  ...
  async validateSuccessfulLogin(): Promise<void> {
    ...
    console.log('✅ Login validation successful - redirected to inventory page');
  }
