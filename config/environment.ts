...
import type { EnvironmentConfig, EnvironmentType, EnvironmentManager } from './types/environment.types';
...
class EnvironmentConfigManagerImpl implements EnvironmentManager {
  ...
  calculateOptimalWorkers(): number {
    ...
    const memoryBasedWorkers = Math.floor(totalMemoryGB / FRAMEWORK_CONSTANTS.PERFORMANCE.MEMORY_PER_WORKER_GB);
...
export const getEnvironmentConfig = EnvironmentConfigManager.getConfig.bind(EnvironmentConfigManager);
export const calculateOptimalWorkers = EnvironmentConfigManager.calculateOptimalWorkers.bind(EnvironmentConfigManager);
export const calculateOptimalShards = EnvironmentConfigManager.calculateOptimalShards.bind(EnvironmentConfigManager);
